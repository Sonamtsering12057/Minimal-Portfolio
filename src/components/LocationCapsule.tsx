...
const LocationCapsule: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <span className="border-l border-black dark:border-white pl-2 ml-2 min-w-[200px] text-center py-1">
          <div className="text-sm">
            based in{" "}
            <span className="text-base">
              <span className="font-bold text-primary">LPU Punjab</span>, India
            </span>
          </div>
      </span>
    </div>
