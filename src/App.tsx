...
function App() {
  return (
    <SmoothScroll>
      <CustomCursor />
      <div className="min-h-screen bg-white dark:bg-[#0a0a0a] text-black dark:text-white selection:bg-primary/30 selection:text-primary relative overflow-hidden">
        {/* Background Elements */}
        <div className="fixed inset-0 bg-grid pointer-events-none opacity-50 dark:opacity-20" />
        ...
        >
          ...
          <footer className="mt-20 py-10">
            <div className="glass p-8 rounded-3xl border border-white/20 dark:border-white/10 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="text-center md:text-left space-y-2">
                <p className="text-lg font-bold tracking-tight">Sonam Tsering</p>
                <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} All rights reserved.</p>
              </div>
              
              <div className="flex items-center gap-4">
                <a href="https://github.com/SonamTsering" target="_blank" rel="noopener noreferrer" className="p-3 rounded-xl glass hover:bg-primary/10 hover:text-primary transition-all">
                ...
                <a href="https://www.linkedin.com/in/sonam-tsering-84754928b/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-xl glass hover:bg-primary/10 hover:text-primary transition-all">
