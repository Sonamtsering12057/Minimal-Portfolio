          ...
          <footer className="mt-20 py-10">
            <div className="glass p-8 rounded-3xl border border-white/20 dark:border-white/10 flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <a href="https://www.linkedin.com/in/SonamTsering" target="_blank" rel="noopener noreferrer" className="p-3 rounded-xl glass hover:bg-primary/10 hover:text-primary transition-all">
